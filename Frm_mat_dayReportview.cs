...
namespace MTsystem_win
{
    public partial class Frm_mat_dayReportview : Form
    {
        ...
        {
            this.mat_dayReportview.Reset();
            string strsql = "SELECT material_out.Material_id,material_out.Material_inside_name,";
            ...
            strsql += " WHERE material_out.Matid = material.Matid AND material_out.Out_date = '" + dtp_Querydate.Value.ToShortDateString().Trim() + "'";
            strsql += " ORDER BY material.Material_class ASC";
